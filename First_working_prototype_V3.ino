...
void setup() {
   ...
   */
   ...
   Homey.begin("Verkstad'n"); //Namnet på noden
...
void loop() {
 ...
 Homey.loop();{ //Skall till för att Homeyn skall hitta de!

  Serial.print(tempArray[2]); Serial.print(" *C, ");
  Serial.print(humiArray[2]); Serial.println(" H");
 ...
 */
 ...
 /*
  * Nolla variablerna så arrayerna kan börja om från noll!
  */
